  ...
  return (
    <div className="container mx-auto px-4 py-20 relative" style={{ backgroundImage: {image2}, backgroundSize: "cover", backgroundPosition: "center", opacity: 0.8 }}>
      ...
      <div className="text-center">
        ...
        <h2 className="text-3xl sm:text-5xl lg:text-6xl mt-10 lg:mt-20 tracking-wide text-lime-300 font-bold ">
          Savannah {" "}
          <span className="bg-gradient-to-r from-lime-200 to-lime-400 text-transparent bg-clip-text font-bold">
            AI
          </span>
        </h2>
      ...
      <span
  className="bg-gradient-to-r from-red-200 to-lime-300 text-transparent bg-clip-text text-lg font-bold text-center"
  style={{ fontSize: '1.5rem' }}
>
Make the best models with the best data. Savannah AI powers the development of AI across African enterprises and institutions with the most relevant, high-quality data. </span>
